...
features:
  ...
  - title: 把 agent 当打工人看
    details: 系统提示词是 JD，skill 是简历与证书，模型分级是资历，长期记忆是履历，持久化沙箱是工作电脑。这套视角会重新排一遍 agent 工程的问题。
  - title: 二部曲的第二部
...
- **从个体到团队**——单个 agent 的岗位讲清楚之后，接下来的问题就是交接、授权、上下文隔离与最终责任。agent 的信息窗口和角色生成方式会改变组织形态，多 agent 工程不做公司仿真，而是重新设计一种团队。
