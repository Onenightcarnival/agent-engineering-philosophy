...
hero:
  name: Agent 工程哲学
  text: ""
  tagline: 当软件系统的核心从概率模型变成自主角色，软件工程要重新理解什么。
  actions:
    - theme: brand
      text: 开始阅读
...
features:
  ...
  - title: 把 agent 当打工人看
    details: 系统提示词是 JD，skill 是简历与证书，模型分级是资历，长期记忆是履历，持久化沙箱是工作电脑。人力资源视角会重新排一遍 agent 工程的问题。
  - title: 二部曲的第二部
...
这些问题想清楚，agent 工程就不再只是调工具、写 loop。更要紧的问题变成：这个 agent 到底是谁，要负责什么，又靠什么把活干完。
