...
# Post-training Is Vocational Education

The second stage of education is post-training.

After pretraining, the model has knowledge and can reason, but it does not necessarily understand instructions, does not necessarily know how to use tools, and does not know which things must not be said. Post-training fills that gap: instruction tuning, human feedback, safety alignment — training the model into a more usable person, one who understands requests, calls tools, holds the safety line, and speaks appropriately.
