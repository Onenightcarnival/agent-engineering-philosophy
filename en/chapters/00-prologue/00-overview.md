...
- [Not Another Agent Framework Guide](01-not-another-agent-framework-guide.md) — What this book is and isn't. It doesn't teach you how to use a framework; it asks how engineering should think when agents move into the core of a software system.
- [A Personal Statement of Position](02-a-personal-statement-of-position.md) — The author's technical preferences, core beliefs, and blind spots. Honest bias beats fake objectivity.
